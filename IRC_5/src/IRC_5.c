 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Apr 08 13:31:07 2021
 */
...
/* Input Port  1 */
#define IN_PORT_1_NAME        position
...
/* Input Port  2 */
#define IN_PORT_2_NAME        euler_ang
...
/* Input Port  3 */
#define IN_PORT_3_NAME        quaternions
...
/* Input Port  6 */
#define IN_PORT_6_NAME        cart_speed
#define INPUT_6_WIDTH         6
...
static void mdlStart(SimStruct *S)
{
    ...
    IRC_5_Start_wrapper(pW, port_1, p_width0, port_2, p_width1, orient_switch, p_width2, tout, p_width3, S);
}
#endif /*  MDL_START */
...
{
    void **pW = ssGetPWork(S);
    const real_T *triger = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *position = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *euler_ang = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *quaternions = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *joints = (real_T *) ssGetInputPortRealSignal(S, 4);
    const real_T *j_speed = (real_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *cart_speed = (real_T *) ssGetInputPortRealSignal(S, 6);
    ...
    IRC_5_Outputs_wrapper(triger, position, euler_ang, quaternions, joints, j_speed, cart_speed, curr_position, curr_angle, curr_quat, curr_joints, force, IRC5_time, testsig, pW, port_1, p_width0, port_2, p_width1, orient_switch, p_width2, tout, p_width3, S);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    IRC_5_Terminate_wrapper(pW, port_1, p_width0, port_2, p_width1, orient_switch, p_width2, tout, p_width3, S);
